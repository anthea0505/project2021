...
<div style="float:left;">校園線上點餐系統-八方雲集</div>
...
<div style="text-align:center;margin-top:30px;">
	<div style="width:80%;height:2000px;margin:40px auto;background:white;font-size:25px;font-weight:bold;float:center;">
		<div style="text-align:left;">
			<h3>&nbsp;&nbsp;&nbsp;<font color="#EB7A77">水餃</font></h3>
			<div class="grid-container" style="font-size:20px;font-weight:bold;">
			<?php 
				$sqlcmd = "SELECT * FROM product_shop WHERE shop_name LIKE '八方雲集' AND pd_category LIKE '水餃'";
			...
			<h3>&nbsp;&nbsp;&nbsp;<font color="#EB7A77">鍋貼</font></h3>
			<div class="grid-container" style="font-size:20px;font-weight:bold;">
			<?php 
				$sqlcmd = "SELECT * FROM product_shop WHERE shop_name LIKE '八方雲集' AND pd_category LIKE '鍋貼'";
				$rs = querydb($sqlcmd, $db_conn);
				for ($i=0; $i<count($rs); $i++) {
			?>
			<?php 
			...
			<h3>&nbsp;&nbsp;&nbsp;<font color="#EB7A77">麵食</font></h3>
			<div class="grid-container" style="font-size:20px;font-weight:bold;">
			<?php 
				$sqlcmd = "SELECT * FROM product_shop WHERE shop_name LIKE '八方雲集' AND pd_category LIKE '麵食'";
				$rs = querydb($sqlcmd, $db_conn);
				for ($i=0; $i<count($rs); $i++) {
			?>
			<?php 
			...
			<h3>&nbsp;&nbsp;&nbsp;<font color="#EB7A77">湯品</font></h3>
			<div class="grid-container" style="font-size:20px;font-weight:bold;">
			<?php 
				$sqlcmd = "SELECT * FROM product_shop WHERE shop_name LIKE '八方雲集' AND pd_category LIKE '湯品'";
				$rs = querydb($sqlcmd, $db_conn);
				for ($i=0; $i<count($rs); $i++) {
			?>
			<?php 
			...
			<h3>&nbsp;&nbsp;&nbsp;<font color="#EB7A77">飲品</font></h3>
			<div class="grid-container" style="font-size:20px;font-weight:bold;">
			<?php 
				$sqlcmd = "SELECT * FROM product_shop WHERE shop_name LIKE '八方雲集' AND pd_category LIKE '飲品'";
				$rs = querydb($sqlcmd, $db_conn);
				for ($i=0; $i<count($rs); $i++) {
			?>
			<?php 

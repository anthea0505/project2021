...
$ItemPerPage = 10;
$sqlcmd = "SELECT count(*) AS reccount FROM product_shop WHERE shop_name='陳記咖哩鐵板'";
...
$sqlcmd = "SELECT * FROM product_shop WHERE shop_name='陳記咖哩鐵板' LIMIT $StartRec,$ItemPerPage";
...
<div style="float:left;">陳記咖哩鐵板餐點管理</div>
<ul class="drop-down-menu-top"style="float:right;">
	...
	<li>
		<a href="shop4_shop_management.php">店家管理</a>
	</li>
	<li>
		<a href="shop_odlist.php">訂單管理</a>
	</li>
	<li>
		<a href="shop4.php">店家頁面</a>
	</li>
	<li>

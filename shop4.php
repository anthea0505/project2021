...
<div style="float:left;">校園線上點餐系統-陳記咖哩鐵板</div>
...
<div style="text-align:center;margin-top:30px;">
	<div style="width:80%;height:1000px;margin:40px auto;background:white;font-size:25px;font-weight:bold;float:center;">
		<div style="text-align:left;">
			<h3>&nbsp;&nbsp;&nbsp;<font color="#EB7A77">飯類</font></h3>
			<div class="grid-container" style="font-size:20px;font-weight:bold;">
			<?php 
				$sqlcmd = "SELECT * FROM product_shop WHERE shop_name LIKE '陳記咖哩鐵板' AND pd_category LIKE '飯類'";
			...
			<h3>&nbsp;&nbsp;&nbsp;<font color="#EB7A77">咖哩</font></h3>
			<div class="grid-container" style="font-size:20px;font-weight:bold;">
			<?php 
				$sqlcmd = "SELECT * FROM product_shop WHERE shop_name LIKE '陳記咖哩鐵板' AND pd_category LIKE '咖哩'";
				$rs = querydb($sqlcmd, $db_conn);
				for ($i=0; $i<count($rs); $i++) {
			?>
			<?php 

...
$ItemPerPage = 10;
$sqlcmd = "SELECT count(*) AS reccount FROM product_shop WHERE shop_name='玉福'";
...
$sqlcmd = "SELECT * FROM product_shop WHERE shop_name='玉福' LIMIT $StartRec,$ItemPerPage";
...
<ul class="drop-down-menu-top"style="float:right;">
	...
	<li>
		<a href="shop2_shop_management.php">店家管理</a>
	</li>
	<li>
		<a href="shop_odlist.php">訂單管理</a>
	</li>
	<li>
		<a href="shop2.php">店家頁面</a>
	</li>
	<li>

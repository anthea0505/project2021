...
$ItemPerPage = 10;
$sqlcmd = "SELECT count(*) AS reccount FROM product_shop WHERE shop_name='小食麵'";
...
$sqlcmd = "SELECT * FROM product_shop WHERE shop_name='小食麵' LIMIT $StartRec,$ItemPerPage";
...
<div style="float:left;">小食麵餐點管理</div>
<ul class="drop-down-menu-top"style="float:right;">
	...
	<li>
		<a href="shop11_shop_management.php">店家管理</a>
	</li>
	<li>
		<a href="shop_odlist.php">訂單管理</a>
	</li>
	<li>
		<a href="shop11.php">店家頁面</a>
	</li>
	<li>

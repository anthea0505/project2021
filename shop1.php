...
<div style="float:left;">校園線上點餐系統-99早餐店</div>
...
<div style="text-align:center;margin-top:30px;">
	<div style="width:90%;height:5500px;margin:40px auto;background:white;font-size:25px;font-weight:bold;float:center;">
		<div style="text-align:left;">
			<h3>&nbsp;&nbsp;&nbsp;<font color="#EB7A77">吐司果醬類</font></h3>
			<div class="grid-container" style="font-size:20px;font-weight:bold;">
			<?php 
				$sqlcmd = "SELECT * FROM product_shop WHERE shop_name LIKE '99早餐店' AND pd_category LIKE '吐司果醬類'";
			...
			<h3>&nbsp;&nbsp;&nbsp;<font color="#EB7A77">吐司現烤類</font></h3>
			<div class="grid-container" style="font-size:20px;font-weight:bold;">
			<?php 
				$sqlcmd = "SELECT * FROM product_shop WHERE shop_name LIKE '99早餐店' AND pd_category LIKE '吐司現烤類'";
				$rs = querydb($sqlcmd, $db_conn);
				for ($i=0; $i<count($rs); $i++) {
			?>
			<?php 
			...
			<h3>&nbsp;&nbsp;&nbsp;<font color="#EB7A77">三明治總匯</font></h3>
			<div class="grid-container" style="font-size:20px;font-weight:bold;">
			<?php 
				$sqlcmd = "SELECT * FROM product_shop WHERE shop_name LIKE '99早餐店' AND pd_category LIKE '三明治總匯'";
				$rs = querydb($sqlcmd, $db_conn);
				for ($i=0; $i<count($rs); $i++) {
			?>
			<?php 
			...
			<h3>&nbsp;&nbsp;&nbsp;<font color="#EB7A77">帕尼尼</font></h3>
			<div class="grid-container" style="font-size:20px;font-weight:bold;">
			<?php 
				$sqlcmd = "SELECT * FROM product_shop WHERE shop_name LIKE '99早餐店' AND pd_category LIKE '帕尼尼'";
				$rs = querydb($sqlcmd, $db_conn);
				for ($i=0; $i<count($rs); $i++) {
			?>
			<?php 
			...
			<h3>&nbsp;&nbsp;&nbsp;<font color="#EB7A77">美味漢堡</font></h3>
			<div class="grid-container" style="font-size:20px;font-weight:bold;">
			<?php 
				$sqlcmd = "SELECT * FROM product_shop WHERE shop_name LIKE '99早餐店' AND pd_category LIKE '美味漢堡'";
				$rs = querydb($sqlcmd, $db_conn);
				for ($i=0; $i<count($rs); $i++) {
			?>
			<?php 
			...
			<h3>&nbsp;&nbsp;&nbsp;<font color="#EB7A77">香酥餅類</font></h3>
			<div class="grid-container" style="font-size:20px;font-weight:bold;">
			<?php 
				$sqlcmd = "SELECT * FROM product_shop WHERE shop_name LIKE '99早餐店' AND pd_category LIKE '香酥餅類'";
				$rs = querydb($sqlcmd, $db_conn);
				for ($i=0; $i<count($rs); $i++) {
			?>
			<?php 
			...
			<h3>&nbsp;&nbsp;&nbsp;<font color="#EB7A77">鐵板麵</font></h3>
			<div class="grid-container" style="font-size:20px;font-weight:bold;">
			<?php 
				$sqlcmd = "SELECT * FROM product_shop WHERE shop_name LIKE '99早餐店' AND pd_category LIKE '鐵板麵'";
				$rs = querydb($sqlcmd, $db_conn);
				for ($i=0; $i<count($rs); $i++) {
			?>
			<?php 
			...
			<h3>&nbsp;&nbsp;&nbsp;<font color="#EB7A77">點心類</font></h3>
			<div class="grid-container" style="font-size:20px;font-weight:bold;">
			<?php 
				$sqlcmd = "SELECT * FROM product_shop WHERE shop_name LIKE '99早餐店' AND pd_category LIKE '點心類'";
				$rs = querydb($sqlcmd, $db_conn);
				for ($i=0; $i<count($rs); $i++) {
			?>
			<?php 
			...
			<h3>&nbsp;&nbsp;&nbsp;<font color="#EB7A77">單品</font></h3>
			<div class="grid-container" style="font-size:20px;font-weight:bold;">
			<?php 
				$sqlcmd = "SELECT * FROM product_shop WHERE shop_name LIKE '99早餐店' AND pd_category LIKE '單品'";
				$rs = querydb($sqlcmd, $db_conn);
				for ($i=0; $i<count($rs); $i++) {
			?>
			<?php 
			...
			<h3>&nbsp;&nbsp;&nbsp;<font color="#EB7A77">飲料</font></h3>
			<div class="grid-container" style="font-size:20px;font-weight:bold;">
			<?php 
				$sqlcmd = "SELECT * FROM product_shop WHERE shop_name LIKE '99早餐店' AND pd_category LIKE '飲料'";
				$rs = querydb($sqlcmd, $db_conn);
				for ($i=0; $i<count($rs); $i++) {
			?>
			<?php 

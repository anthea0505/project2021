...
$ItemPerPage = 10;
$sqlcmd = "SELECT count(*) AS reccount FROM product_shop WHERE shop_name='99早餐店'";
...
<div style="float:left;">99早餐店餐點管理</div>
<ul class="drop-down-menu-top"style="float:right;">
	...
	<li>
		<a href="shop1_shop_management.php">餐點管理</a>
	</li>
	<li>
...
<table style="border:3px solid;" border="1" width="90%" align="center" cellpadding="10" cellpadding="2">
	...
	$sqlcmd = "SELECT * FROM product_shop WHERE shop_name='99早餐店' LIMIT $StartRec,$ItemPerPage";
	...
	<td>
	<?php 
		if($sold_out=='N')echo "否";
		if($sold_out=='Y')echo "是";
	?></td> 
